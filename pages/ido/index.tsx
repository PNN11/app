...
const IDOPage: NextPage = () => {
    ...
    const submitForm = async (values): Promise<void> => {
        ...
        if (res?.[0]?._id) {
            ...
            sendAnalyticsEvent({
                event: 'submit_form',
                options: { formName: 'ido-whitelist' },
            })
        }
    }
                ...
                <SubmittedFormWrapper
                    ...
                    submittedComponent={
                        <h3 className="text-custom-2.5xl font-medium">
                            Thank you for IDO White List Registration!
                        </h3>
                    }
                >
                    <WrapperForm
